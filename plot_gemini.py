...
hdf5_path = r"C:\Users\USER\Desktop\test_output\pred_068_manual_overlap.h5" # Cesta k opravenému souboru
...
plt.subplot(1, 3, 1)
plt.imshow(gt_mask_thumb, cmap="gray", vmin=0, vmax=1) # Explicitně nastavit vmin/vmax
...
plt.subplot(1, 3, 3)
plt.imshow(small_mask2, cmap="gray", vmin=0, vmax=1) # Explicitně nastavit vmin/vmax
