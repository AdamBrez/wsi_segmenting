...
for x in range(61, 62):
    if x == 84 or x == 89 or x == 91:
        continue
# Cesta k WSI
    slide_path = r"C:\Users\USER\Desktop\wsi_dir\tumor_"+f"{x}"+".tif"
    ...
    np.save(r"C:\Users\USER\Desktop\colab_unet\masky_new\mask_"+f"{x}"+".npy", mask_final)
